...
enum Key
{
	...
	KV_LCTRL = SDL_Scancode::SDL_SCANCODE_LCTRL,
	KV_LSHIFT = SDL_Scancode::SDL_SCANCODE_LSHIFT,
	KV_LALT = SDL_Scancode::SDL_SCANCODE_LALT,
	KV_LGUI = SDL_Scancode::SDL_SCANCODE_LGUI,

	KV_RCTRL = SDL_Scancode::SDL_SCANCODE_RCTRL,
	KV_RSHIFT = SDL_Scancode::SDL_SCANCODE_RSHIFT,
	KV_RALT = SDL_Scancode::SDL_SCANCODE_RALT,
	KV_RGUI = SDL_Scancode::SDL_SCANCODE_RGUI,
